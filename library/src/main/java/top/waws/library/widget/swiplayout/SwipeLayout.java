...
import top.waws.library.widget.swiplayout.utils.BlurUtil;
import top.waws.library.widget.swiplayout.utils.SizeUtil;
...
public class SwipeLayout extends ViewGroup {
    ...
    private void initObtainStyledAttr(Context context, AttributeSet attrs) {
        ...
        mType = array.getInteger(R.styleable.SwipeLayout_sm_type, 1111);
        mDragWipeOffset = (int) array.getDimension(R.styleable.SwipeLayout_sm_dragOffset, SizeUtil.Dp2Px(context, 100));
        mMenuOffset = (int) array.getDimension(R.styleable.SwipeLayout_sm_menuOffset, SizeUtil.Dp2Px(context, 50));
        mStartScale = array.getFloat(R.styleable.SwipeLayout_sm_startScale, 0.2f);
        mStartAlpha = array.getFloat(R.styleable.SwipeLayout_sm_startAlpha, 0.2f);
        mStart3DAngle = array.getInteger(R.styleable.SwipeLayout_sm_start3Dangle, 60);
        array.recycle();
    }
